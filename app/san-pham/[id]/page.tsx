...
async function getProduct(slug: string) {
  const query = `*[_type == "product" && slug.current == $slug][0] {
    ...
    variants // <-- Đã thêm dòng này để lấy các biến thể
  }`;
      ...
      <section className="max-w-7xl mx-auto px-6 mb-16">
        <div className="bg-white rounded-3xl shadow-sm border border-earth/10 p-6 md:p-12 grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="flex flex-col h-full justify-center">
            ...
            <h1 className="text-3xl md:text-4xl font-bold text-earth-dark mb-6 leading-tight">
              {product.name}
            </h1>
            
            {/* Mình đã chuyển giá tiền vào OrderSection để nó tự nhảy số */}
            ...
            {/* GỌI COMPONENT NÚT BẤM (Kèm cả giá và biến thể) */}
