      ...
      <div className="max-w-7xl mx-auto px-6">
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              <li className="flex items-start">
                ...
                <span>48 Bàu Trảng 5, Q.Thanh Khê, TP.Đà Nẵng</span>
              </li>
              <li className="flex items-center group">
                <svg className="w-5 h-5 mr-3 text-earth flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                </svg>
                <a href="mailto:trungtu2k6@gmail.com" className="hover:text-earth transition-colors duration-300">
                  trungtu2k6@gmail.com
                </a>
              </li>
              ...
              <li className="flex items-center group">
                ...
                <a href="tel:0776910286" className="hover:text-earth transition-colors duration-300 font-medium">
                  077 6910 286
                </a>
              </li>
            </ul>
        ...
        <div className="border-t border-white/10 pt-8 flex flex-col md:flex-row justify-between items-center text-xs">
          ...
          <div className="mt-4 md:mt-0 space-x-6">
            ...
            <Link href="/dieu-khoan-dich-vu" className="hover:text-white transition-colors">Điều khoản dịch vụ</Link>
          </div>
        </div>
      </div>
    </footer>
